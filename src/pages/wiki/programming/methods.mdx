...
<ChapterButtons 
  previous={{name: 'Einstieg in die Programmierung', url: '/wiki/programming/getting-started'}}
  next={{name:'Herausforderung: Methoden', url: '/wiki/programming/challenge-methods'}}
/>